...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/csharp-031-csharp-projeto-trybank.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd csharp-031-csharp-projeto-trybank`
  ...
  - Agora crie uma branch à qual você vai submeter os `commits` do seu projeto.
    ...
    - Exemplo: `git checkout -b joaozinho-csharp-031-csharp-projeto-trybank`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-csharp-031-csharp-projeto-trybank`.

  6. Crie um novo `Pull Request` _(PR)_

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/csharp-031-csharp-projeto-trybank/pulls).
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/csharp-031-csharp-projeto-trybank/pulls) e confira que o seu _Pull Request_ está criado.
...
<details>
  ...
  - Vá até a página **DO SEU** _Pull Request_, adicione a label de _"code-review"_ e marque seus colegas:
    ...
    - No menu à direita, clique no _link_ **"Reviewers"** e digite `students`, selecione o time `tryber/students-sd-031-csharp`.
...
[Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH31-CSHARP&template=betrybe/csharp-0x-projeto-trybank)
